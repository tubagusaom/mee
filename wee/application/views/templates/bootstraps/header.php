...
<html>
	...
	<body data-target="#header" data-spy="scroll" data-offset="100">
		...
		<!-- <audio id="audio1" controls autoplay="true" loop="true" preload controlsList="nodownload">
 			<source src="<?=base_url()?>_assets/audio/club_eighties-dari_hati.mp3" type="audio/mp3"></source>
 	  </audio> -->

		<!-- <video id="video1" width="420" controls loop muted autoplay >
      <source src="<?=base_url()?>_assets/audio/club_eighties-dari_hati.mp4" type="video/mp4" />
    ...
    <!-- </header> -->
		...
		<?php
			// $this->load->view("templates/bootstraps/login");
		?>
