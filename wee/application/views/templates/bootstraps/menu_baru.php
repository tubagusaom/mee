  ...
  <ul class="nav__list">
    ...
    <li class="nav__item">
      <a href="javascript:void(0)" class="nav__link c-yellow scrolly" menuid-tb="thewedding">
        ...
        <span class="c-yellow">Date</span>
      </a>
    </li>

    <li class="nav__item">
      <a href="javascript:void(0)" class="nav__link c-red" menuid-tb="photos">
        <i class="fa fa-picture-o"></i>
        <span class="c-red">Story</span>
      </a>
    </li>
    ...
    <li class="nav__item">
      <a href="javascript:void(0)" class="nav__link c-green" menuid-tb="guestbook">
        ...
        <span class="c-green">Guest Book</span>
      </a>
    </li>
  </ul>
</nav>
